#include "joint_driver/joint_driver.hpp"
...
namespace joint_driver
{
     ...
     * @return A return status
     */
    hardware_interface::return_type joint_driver ::ArduinoHardware::write(
        const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
    {
        if (!comms_.connected())
        {
...
PLUGINLIB_EXPORT_CLASS(
    joint_driver::ArduinoHardware, hardware_interface::SystemInterface)